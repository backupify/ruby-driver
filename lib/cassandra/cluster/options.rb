...
module Cassandra
  class Cluster
    # @private
    class Options
      attr_reader :credentials, :auth_provider, :compressor, :port_lookup,
                  :connect_timeout, :ssl, :heartbeat_interval, :idle_timeout,
                  :schema_refresh_delay, :schema_refresh_timeout
      attr_accessor :protocol_version

      def initialize(protocol_version, credentials, auth_provider, compressor, port_lookup, connect_timeout, ssl, connections_per_local_node, connections_per_remote_node, heartbeat_interval, idle_timeout, synchronize_schema, schema_refresh_delay, schema_refresh_timeout, client_timestamps)
